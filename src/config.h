...
// Control variables
#define POWER_UP_DELAY 300                       // Power-up safety delay (recomended 3s)
#define REFRESH_INTERVAL 10000                   // Time to reset the strip to the baseline state
...
#define COLOR_TURN_SIGNAL CRGB::OrangeRed        // Color for turn signal
